"""Turtle Scene Project - The Andes Mountains!"""
...
def welcome(bob: Turtle = Turtle()) -> None:
    ...
    bob.write("Welcome to the Andes!", align="center", font=("Verdana", 32, "normal"))
    bob.hideturtle()
...
def rectangle(x: float, mia: Turtle = Turtle()) -> None:
    """Formula to make rectangles with stable length and changing width."""
    idx: int = 0
    while idx < 2:
        mia.forward(1200)
        mia.right(90)
...
def mountains1(x: float, y: float, harry: Turtle = Turtle()) -> None:
    """Function for first set of mountains."""
    harry.speed(50)
    harry.hideturtle()
...
def mountains2(x: float, y: float, niall: Turtle = Turtle()) -> None:
    """Function for second set of mountains."""
    niall.speed(50)
    niall.hideturtle()
...
def mountains3(x: float, y: float, liam: Turtle = Turtle()) -> None:
    """Function for third set of mountains."""
    liam.speed(50)
    liam.hideturtle()
